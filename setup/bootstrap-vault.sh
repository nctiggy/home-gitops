...
loadSecretsToVault() {
  ...
  vault kv put secrets/kasten-io/kasten/kasten-auth htpasswd="$KASTEN_AUTH"
  ...
  kvault "media/nzbget/nzbget-helm-values.txt"
  ...
  kvault "media/calibre-web/calibre-web-helm-values.txt"
  ...
  kvault "kasten-io/kasten/kasten-helm-values.txt"
}
